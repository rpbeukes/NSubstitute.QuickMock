...
<!-- squad:capabilities schema=1 specialists=2 taskTypes=2 hints=0 -->
...
| --- | --- | --- | --- |
| Neo | Team Lead / Architect | advisory | — |
| Tank | Testing Specialist | advisory | — |

### Supported task types

Team Lead / Architect, Testing Specialist
...
- **Cannot (no agent claims this):** review code and pull requests; write and modify code; write and maintain documentation; security and secrets review; responsible-AI and content-safety review; cut releases and publish packages; author and maintain CI/CD workflows; UX and visual design; deploy to live environments
